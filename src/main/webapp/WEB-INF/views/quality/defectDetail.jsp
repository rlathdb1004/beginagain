...
<c:otherwise>
<form id="defectUpdateForm" action="${pageContext.request.contextPath}/defectRegInq" method="post">
<input type="hidden" name="cmd" value="update"><input type="hidden" name="defectProductId" value="${defectRegInqDTO.defectProductId}">
...
<tr><th class="taFormLabel">완제품검사번호</th><td class="taFormValue"><span class="taReadonlyText">${defectRegInqDTO.finalInspectionId}</span></td></tr>
<tr><th class="taFormLabel">생산실적번호</th><td class="taFormValue"><span class="taReadonlyText">${defectRegInqDTO.resultId}</span></td></tr>
<tr><th class="taFormLabel">작업지시번호</th><td class="taFormValue"><span class="taReadonlyText">${defectRegInqDTO.workOrderId}</span></td></tr>
...
<tr><th class="taFormLabel">검사수량(참고)</th><td class="taFormValue"><span class="taReadonlyText">${defectRegInqDTO.inspectQty}</span></td></tr>
<tr><th class="taFormLabel">검사판정</th><td class="taFormValue"><span class="taReadonlyText">${defectRegInqDTO.inspectionStatus}</span></td></tr>
...
<tr><th class="taFormLabel">등록된 불량코드 수</th><td class="taFormValue"><span class="taReadonlyText">${defectRegInqDTO.defectCodeCount}</span></td></tr>

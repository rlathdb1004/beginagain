						...
						<tr class="taTableBodyRow">
							...
							<td class="taTableBodyCell taColAction taLastCol"><form
									...
									<input type="hidden" name="cmd" value="detail"><input
										...
										value="${dto.materialInspectionId}">
...
<c:if test="${not empty matInspRegInqDTO}">
	<div class="taTableShell" style="padding: 20px; margin-top: 20px;">
		...
		<p>
			<strong>자재검사번호 :</strong> ${matInspRegInqDTO.materialInspectionId}
		</p>
		<p>
			<strong>품목코드 :</strong> ${matInspRegInqDTO.itemCode}
		</p>
		<p>
			<strong>품목명 :</strong> ${matInspRegInqDTO.itemName}
		</p>
		<p>
			<strong>검사수량 :</strong> ${matInspRegInqDTO.inspectQty}
		</p>
		<p>
			<strong>양품수량 :</strong> ${matInspRegInqDTO.goodQty}
		</p>
		<p>
			<strong>불량수량 :</strong> ${matInspRegInqDTO.defectQty}
		</p>
		<p>
			<strong>판정 :</strong> ${matInspRegInqDTO.result}
		</p>
		<p>
			<strong>검사일 :</strong> ${matInspRegInqDTO.inspectionDate}
		</p>
		<p>
			<strong>비고 :</strong> ${matInspRegInqDTO.remark}
		</p>
	</div>
</c:if>
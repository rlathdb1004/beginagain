...
<c:if test="${not empty fpInspRegInqDTO}">
	<div class="taTableShell" style="padding: 20px; margin-top: 20px;">
		...
		<p>
			<strong>완제품검사번호 :</strong> ${fpInspRegInqDTO.finalInspectionId}
		</p>
		<p>
			<strong>생산실적번호 :</strong> ${fpInspRegInqDTO.resultId}
		</p>
		<p>
			<strong>작업지시번호 :</strong> ${fpInspRegInqDTO.workOrderId}
		</p>
		<p>
			<strong>품목코드 :</strong> ${fpInspRegInqDTO.itemCode}
		</p>
		<p>
			<strong>품목명 :</strong> ${fpInspRegInqDTO.itemName}
		</p>
		<p>
			<strong>LOT번호 :</strong> ${fpInspRegInqDTO.lotNo}
		</p>
		<p>
			<strong>검사수량 :</strong> ${fpInspRegInqDTO.inspectQty}
		</p>
		<p>
			<strong>판정 :</strong> ${fpInspRegInqDTO.result}
		</p>
		<p>
			<strong>검사일 :</strong> ${fpInspRegInqDTO.inspectionDate}
		</p>
		<p>
			<strong>비고 :</strong> ${fpInspRegInqDTO.remark}
		</p>
	</div>
</c:if>
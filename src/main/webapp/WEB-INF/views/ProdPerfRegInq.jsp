...
<div class="prodperf-page">
	...
	<%-- 검색 폼 --%>
	<!--     페이징기능 추가하기 위해 아래 주석처리 후 새로운 코드삽입함 / 령 -->
...
<!--  									상세보기 버튼: 모달 연결용 data-* 저장 --%> -->
 									<td class="taTableBodyCell taColAction taLastCol"> 
 										<button type="button" class="taLinkButton detailBtn">
											...
											data-itemname="${dto.itemName}" 
 											...
 											data-lossqty="${dto.lossQty}" data-unit="${dto.unit}"
											data-linecode="${dto.lineCode}" data-lotno="${dto.lotNo}" 
 											data-status="${dto.status}" data-remark="${dto.remark}"> 
<!-- 											상세보기</button> -->
 									</td>
 								</tr> 
 							</c:forEach> 
...
<%--                                 colspan 은 체크박스 컬럼 포함 총 13칸 --%>
 							...
 							<c:if test="${empty list}">
 								<tr class="taTableBodyRow">
 									<td class="taTableBodyCell taLastCol" colspan="13" 

...
.workStatusPage .taSearchBtn,
.workStatusPage .taSearchReset {
    flex-shrink: 0;
    height: 40px;
}
...
.workStatusPage .taTableBodyCell {
    padding: 10px 6px;
    white-space: nowrap;
    overflow: hidden;
...
/* 컬럼 폭 조정 */
.workStatusPage .taMesTable th:nth-child(1),
.workStatusPage .taMesTable td:nth-child(1) {
    width: 108px;
    min-width: 108px;
    max-width: 108px;
}

.workStatusPage .taMesTable th:nth-child(2),
.workStatusPage .taMesTable td:nth-child(2) {
    width: 140px;
    min-width: 140px;
    max-width: 140px;
}

.workStatusPage .taMesTable th:nth-child(3),
.workStatusPage .taMesTable td:nth-child(3) {
    width: 88px;
    min-width: 88px;
    max-width: 88px;
}

.workStatusPage .taMesTable th:nth-child(4),
.workStatusPage .taMesTable td:nth-child(4) {
    width: 88px;
    min-width: 88px;
    max-width: 88px;
}

.workStatusPage .taMesTable th:nth-child(5),
.workStatusPage .taMesTable td:nth-child(5) {
    width: 88px;
    min-width: 88px;
    max-width: 88px;
}

.workStatusPage .taMesTable th:nth-child(6),
.workStatusPage .taMesTable td:nth-child(6) {
    width: 88px;
    min-width: 88px;
    max-width: 88px;
}

.workStatusPage .taMesTable th:nth-child(7),
.workStatusPage .taMesTable td:nth-child(7) {
    width: 78px;
    min-width: 78px;
    max-width: 78px;
}

.workStatusPage .taMesTable th:nth-child(8),
.workStatusPage .taMesTable td:nth-child(8) {
    width: 88px;
    min-width: 88px;
    max-width: 88px;
}

.workStatusPage .taMesTable th:nth-child(9),
.workStatusPage .taMesTable td:nth-child(9) {
    width: 88px;
    min-width: 88px;
    max-width: 88px;
}

.workStatusPage .taMesTable th:nth-child(10),
.workStatusPage .taMesTable td:nth-child(10) {
    width: 84px;
    min-width: 84px;
    max-width: 84px;
    text-align: center;
        ...
        <div class="taTableScroll">
            <table class="taMesTable" id="workStatusTable">
                ...
                <tbody id="workStatusTableBody">
                    <c:choose>
                        <c:when test="${not empty workStatusList}">
                            <c:forEach var="ws" items="${workStatusList}">
                                ...
                                <tr class="taTableBodyRow ${parsedWorkDate lt today and ws.progressRate lt 100 ? 'is-overdue-row' : ''}">
                                    ...
                                    <td class="taTableBodyCell taColFit"
                                        data-search-key="empName">${ws.empName}</td>
                                    <td class="taTableBodyCell taColDate">${ws.workDate}</td>
                                    <td class="taTableBodyCell taColFit">
                                        <fmt:formatNumber value="${ws.workQty}" pattern="#,##0.###" />
                                    </td>
                                    <td class="taTableBodyCell taColFit">
                                        <fmt:formatNumber value="${ws.producedQty}" pattern="#,##0.###" />
                                    </td>
                                    <td class="taTableBodyCell taColFit">
                                        <fmt:formatNumber value="${ws.lossQty}" pattern="#,##0.###" />
                                    </td>
                                    <td class="taTableBodyCell taColFit" style="text-align:center; font-weight:700;">
                                        <fmt:formatNumber value="${ws.progressRate}" pattern="0.0" />%
                                    </td>
                                    <td class="taTableBodyCell taColFit"
                                        data-search-key="progressStatus">
                                        <span class="taStatusBadge ${ws.progressStatus eq '완료' ? 'is-done' : ws.progressStatus eq '진행중' ? 'is-run' : 'is-wait'}">
                                            ${ws.progressStatus}
                                        </span>
                                    </td>
                    ...
                    <tr class="taTableBodyRow" id="workStatusEmptyRow" style="display:none;">
                        <td class="taTableBodyCell taLastCol" colspan="10" style="text-align:center;">
                            조회된 작업 현황이 없습니다.
                        </td>
                    </tr>
                </tbody>

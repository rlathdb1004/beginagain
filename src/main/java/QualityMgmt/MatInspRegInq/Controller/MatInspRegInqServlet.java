...
public class MatInspRegInqServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		forwardList(request, response, new MatInspRegInqDTO(), null);
	}
	...
	private void register(HttpServletRequest request, HttpServletResponse response)
		...
		dto.setInspectionDate(
				(inspectionDate == null || "".equals(inspectionDate)) ? new Date(System.currentTimeMillis())
						: Date.valueOf(inspectionDate));
	...
	private void detail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		forwardList(request, response, new MatInspRegInqDTO(), dto);
	}


	private void forwardList(HttpServletRequest request, HttpServletResponse response, MatInspRegInqDTO searchDTO,
	        MatInspRegInqDTO detailDTO) throws ServletException, IOException {
	    ...
	    if (detailDTO != null) {
	        request.setAttribute("matInspRegInqDTO", detailDTO);
	    }

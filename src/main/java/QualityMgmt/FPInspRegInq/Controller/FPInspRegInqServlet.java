...
public class FPInspRegInqServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		forwardList(request, response, new FPInspRegInqDTO(), null);
	}
	...
	private void detail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		forwardList(request, response, new FPInspRegInqDTO(), dto);
	}

	private void forwardList(HttpServletRequest request, HttpServletResponse response, FPInspRegInqDTO searchDTO,
			FPInspRegInqDTO detailDTO) throws ServletException, IOException {
	    ...
	    if (detailDTO != null) {
	        request.setAttribute("fpInspRegInqDTO", detailDTO);
	    }

...
public class IORegInqServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		forwardList(request, response, new IORegInqDTO(), null);
	}
	...
	private void register(HttpServletRequest request, HttpServletResponse response)
		...
		dto.setInoutDate((inoutDate == null || "".equals(inoutDate)) ? new Date(System.currentTimeMillis())
	...
	private void detail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		forwardList(request, response, new IORegInqDTO(), dto);
	}
	...
	private void forwardList(HttpServletRequest request, HttpServletResponse response, IORegInqDTO searchDTO,
			IORegInqDTO detailDTO) throws ServletException, IOException {
	    ...
	    if (detailDTO != null) {
	        request.setAttribute("ioRegInqDTO", detailDTO);
	    }

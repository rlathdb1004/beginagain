...
public class InvRegInqServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		forwardList(request, response, new InvRegInqDTO(), null);
	}
	...
	private void detail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		forwardList(request, response, new InvRegInqDTO(), dto);
	}

	private void forwardList(HttpServletRequest request, HttpServletResponse response, InvRegInqDTO searchDTO,
	        InvRegInqDTO detailDTO) throws ServletException, IOException {
	    ...
	    if (detailDTO != null) {
	        request.setAttribute("invRegInqDTO", detailDTO);
	    }

	    request.setAttribute("pageId", "page-materials-inventory");
	    request.setAttribute("pageTitle", "재고 등록 / 조회");
	    request.setAttribute("pageSubTitle", "현재 재고 현황을 등록하고 조회하는 화면");
